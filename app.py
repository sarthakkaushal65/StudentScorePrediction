...
# 🌄 Apply background image (make sure the file is in same folder)
set_bg_from_local("study_background.jpg")  # Replace with your file name if needed
...
st.markdown("This app uses a machine learning model to predict a student's exam score based on various academic and lifestyle features.")
